    ...
    if response.status_code == 200:
        ...
        try:
            ...
            if not selected_data.empty:
                ...
                #selected_data["Traffic Total (Speed)"].fillna("< 0.01", inplace=True)
                #selected_data.loc[:, "Traffic Total (Speed)"].fillna("< 0.01", inplace=True)
                ...
                if flags.get("max") == '1':
                    ...
                    if flags.get("thr") == '1' and id_value in upper_error_limits and id_value in upper_warning_limits:
                        ...
                        output_text += f"Error: Upper error limit or warning limit not set for ID {id_value}\n\n"
